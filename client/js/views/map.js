(function(){
	...
	App.View.MapView = Backbone.View.extend({
	    ...
	    render:function(){
	    	...
	    	var MAP = new MapCanvas({ $el: self.$el });
				MAP.init();
	...
	function MapCanvas(options){
		...
		// 		colorRGB:[255,39,91],
		// 		locations:[
		// 			{ x:400, y:400, scale:100, title:'title1' },
		// 			{ x:1000, y:450, scale:50, title:'title2' },
		// 			{ x:1800, y:900, scale:25, title:'title3' },
		// 			{ x:190, y:680, scale:120, title:'title4' }
		// 		]
		// 	},
		// 	other:{
		// 		colorRGB:[0,204,204],
		// 		locations:[
		// 			{ x:200, y:490, scale:50, title:'title1' },
		// 			{ x:1400, y:600, scale:250, title:'title2' },
		// 			{ x:1000, y:70, scale:120, title:'title3' }
		// 		]
		// 	}
		// };
		...
		this.initAnimation = function(){
			...
			self.stage.addChild(hkxDot);
			self.stage.addChild(hkxCircle);
				...
				self.Tl
					...
					_.each(eventCategory.markers.marks, function(mark,i){
						...
						self.Tl
							...
							.to(mark, 0.5, { alpha:0.0 },"-=0.5")
							.set({},{},"+=0.1");
					});

					self.Tl
						.to(eventCategory.markers.dots, 0.5, { scaleX:0, scaleY:0, ease: Expo.easeOut },"+=1.5")
